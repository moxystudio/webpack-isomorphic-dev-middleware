...
function checkHashes(compiler, reporterOptions) {
...
function checkHumanErrors(compiler, options, reporterOptions) {
    ...
    options.memoryFs && checkHashes(compiler, reporterOptions);
}
